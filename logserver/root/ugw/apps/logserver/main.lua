...
local logdir = arch.isx86() and "/ugw/log/wac" or "/tmp/ugw/log"
...
local max_logsize = arch.isx86() and 1024 * 1024 * 4 or 1024 * 200
local maxfiles = arch.isx86() and 10 or 3
...
local function get_version_stamp()
	...
	local pattern = arch.isx86() and "%-(%d%d%d%d%d%d%d%d%d%d)" or "%.(%d%d%d%d%d%d%d%d%d%d)"
